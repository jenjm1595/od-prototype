import svgPaths from "./svg-wtzt8uya64";
...
function ExpandLess() {
  return (
    <div className="relative shrink-0 size-[20px] z-[1]" data-name="expand_less">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="expand_less">
          <path d={svgPaths.p37b75d70} fill="var(--fill-0, #84899F)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function FileUpload1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="file_upload">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="file_upload">
          <path d={svgPaths.p332ba80} fill="var(--fill-0, #84899F)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function TableChart() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="table_chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="table_chart">
          <path d={svgPaths.p25855100} fill="var(--fill-0, #84899F)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Text & Icon">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] items-center overflow-clip relative rounded-[inherit] w-full">
        <p className="font-['GT_America:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3e4260] text-[14px] text-nowrap whitespace-pre">Search for a table</p>
      </div>
    </div>
  );
}
...
function Section() {
  return (
    <div className="h-[70px] relative shrink-0 w-full" data-name="Section">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[70px] items-center p-[16px] relative w-full">
          <Input2 />
          <Button3 />
        </div>
      </div>
...
function Link() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="link">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="link">
          <path d={svgPaths.p23544900} fill="var(--fill-0, #113B61)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Container3() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative" data-name="Container">
      <Container2 />
      <p className="[grid-area:1_/_1] font-['GT_America:Regular',_sans-serif] leading-[24px] ml-0 mt-[24px] not-italic relative text-[#3e4260] text-[14px] text-nowrap whitespace-pre">Required</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative" data-name="Container">
      <Container14 />
      <p className="[grid-area:1_/_1] font-['GT_America:Regular',_sans-serif] leading-[24px] ml-0 mt-[24px] not-italic relative text-[#3e4260] text-[14px] text-nowrap whitespace-pre">Optional</p>
    </div>
  );
}
...
export default function ViewTable() {
  return (
    <div className="bg-white relative size-full" data-name="View table">
