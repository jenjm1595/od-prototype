import svgPaths from "./svg-4sd1sbo02s";
  ...
  return (
    <div className="bg-white h-[65px] relative shrink-0 w-full" data-name="Grid Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[12px] h-[65px] items-center px-[16px] py-0 relative w-full">
          <div className="basis-0 flex flex-col font-['IBM_Plex_Sans:Regular',_sans-serif] grow h-full justify-center leading-[0] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#3e4260] text-[14px] text-nowrap">
            <p className="[white-space-collapse:collapse] leading-[24px] overflow-ellipsis overflow-hidden">ID</p>
          </div>
        </div>
      </div>
    </div>
...
function Column1() {
  return (
    <div className="content-stretch flex flex-col h-[438px] items-start relative shrink-0 w-[363px]" data-name="Column">
      <ColumnHeader8 />
      <ClippedGrid1 />
    </div>
  );
...
function Column5() {
  return (
    <div className="content-stretch flex flex-col items-start relative self-stretch shrink-0 w-[190px]" data-name="Column">
      <ColumnHeader12 />
      <ClippedGrid10 />
    </div>
  );
...
function Label4() {
  return (
    <div className="content-stretch flex gap-[4px] items-center justify-center relative shrink-0" data-name="Label">
      <p className="font-['GT_America:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3e4260] text-[14px] text-nowrap whitespace-pre">Don’t import data in unmapped columns</p>
    </div>
  );
}
...
function Checkbox1() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center justify-end left-[1022px] top-[15px]" data-name="Checkbox">
      <Checkbox />
      <Value />
    </div>
  );
...
function Frame675679920() {
  return (
    <div className="h-[32px] relative shrink-0 w-[1392px]">
      <Frame675679933 />
      <Frame68 />
      <div className="absolute flex flex-col font-['GT_America:Medium',_sans-serif] justify-center leading-[0] left-[1299px] not-italic text-[#3e4260] text-[14px] text-nowrap text-right top-[5px] translate-x-[-100%] translate-y-[-50%]">
        <p className="leading-[24px] whitespace-pre">You have 3 unmapped columns</p>
      </div>
      <Checkbox1 />
    </div>
  );
...
export default function MapMissingRequiredField() {
  return (
    <div className="bg-white relative size-full" data-name="Map - missing required field">
