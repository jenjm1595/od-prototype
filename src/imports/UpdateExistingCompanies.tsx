import svgPaths from "./svg-reb2fv12a4";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Checkbox">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Checkbox">
          <path d={svgPaths.p2c44b00} fill="var(--fill-0, #2062D5)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Value() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0" data-name="Value">
      <Label6 />
    </div>
  );
}
...
function Group156() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] h-full inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] flex flex-col font-['GT_America:Medium',_sans-serif] justify-center ml-0 mt-[12px] not-italic relative text-[#3e4260] text-[16px] text-nowrap translate-y-[-50%]">
        <p className="leading-[24px] whitespace-pre">Required fields</p>
      </div>
    </div>
  );
}
...
function HeadingBlock4() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex gap-[16px] items-center ml-0 mt-0 relative w-[757px]" data-name="Heading block">
      <Wrapper4 />
    </div>
  );
}
...
function TextBlock2() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex flex-col gap-[4px] items-start justify-center ml-[0.009px] mt-[32.576px] relative w-[728px]" data-name="Text block">
      <div aria-hidden="true" className="absolute border-0 border-solid border-white inset-0 pointer-events-none" />
      <div className="flex flex-col font-['GT_America:Regular',_sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#3e4260] text-[0px] w-[min-content]">
        <p className="leading-[24px] text-[14px]">
          <span>{`Download an `}</span>
          <span className="[text-underline-position:from-font] decoration-solid underline">excel template here</span>
          <span>{` with the fields required for import`}</span>
        </p>
      </div>
    </div>
  );
...
function Group158() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] h-full inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] flex flex-col font-['GT_America:Medium',_sans-serif] justify-center ml-0 mt-[12px] not-italic relative text-[#3e4260] text-[16px] text-nowrap translate-y-[-50%]">
        <p className="leading-[24px] whitespace-pre">Upload a file</p>
      </div>
    </div>
  );
}
...
function TextBlock3() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0 w-full" data-name="Text block">
      <div aria-hidden="true" className="absolute border-0 border-solid border-white inset-0 pointer-events-none" />
      <div className="flex flex-col font-['GT_America:Regular',_sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#3e4260] text-[0px] w-[min-content]">
        <p className="leading-[24px] text-[14px]">Select the CSV file that contains your profile data. File size can’t exceed 50 MB.</p>
      </div>
    </div>
  );
}
...
function Upload2() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="upload">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="upload">
          <path d={svgPaths.p1ea0100} fill="var(--fill-0, #84899F)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Button5() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[4px] h-[32px] items-center justify-center px-[9px] py-[5px] relative rounded-[3px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#aeb2bc] border-solid inset-0 pointer-events-none rounded-[3px]" />
      <Upload2 />
      <p className="font-['GT_America:Medium',_sans-serif] leading-[24px] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#3e4260] text-[14px] text-nowrap whitespace-pre">Select file</p>
    </div>
  );
}

function SelectDetails1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Select details">
      <Button5 />
      <p className="font-['GT_America:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#646882] text-[14px] w-[325px]">or drag and drop your file here</p>
    </div>
  );
}

function FileIconsHiddenFileIconBase() {
  return (
    <div className="absolute inset-0" data-name="File icons/_Hidden/File icon base">
      <div className="absolute inset-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 42">
          <path d={svgPaths.p290fab40} fill="var(--fill-0, #ECEFF1)" id="Rectangle 74" />
        </svg>
      </div>
        ...
        <div className="flex-none h-[11.053px] rotate-[180deg] w-[9.844px]">
          <div className="relative size-full">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 12">
              <path d={svgPaths.p31d06a00} fill="var(--fill-0, #CFD8DC)" id="Vector 1" />
            </svg>
          </div>
        </div>
      </div>
...
function FileIcons() {
  return (
    <div className="h-[42px] relative shrink-0 w-[35px]" data-name="File icons">
      <FileIconsHiddenFileIconBase />
      <div className="absolute bottom-[42.1%] left-1/4 right-1/4 top-[34.21%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 10">
          <path d={svgPaths.p10606680} fill="var(--fill-0, #D5D7DD)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Frame4() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px not-italic relative shrink-0">
      <p className="[white-space-collapse:collapse] font-['GT_America:Medium',_sans-serif] h-[24px] leading-[24px] overflow-ellipsis overflow-hidden relative shrink-0 text-[#3e4260] text-[14px] text-nowrap w-full">Customerfile.csv</p>
      <p className="font-['GT_America:Regular',_sans-serif] h-[24px] leading-[18px] relative shrink-0 text-[#646882] text-[13px] w-[180px]">CSV, 48Kb</p>
    </div>
  );
}
...
function CheckCircle() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="check_circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="check_circle">
          <path d={svgPaths.p3b7a7680} fill="var(--fill-0, #008580)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="close">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="close">
          <rect fill="var(--fill-0, white)" height="18" rx="3" width="18" />
          <path d={svgPaths.p3b6da800} fill="var(--fill-0, #3E4260)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function UploadFileSelcted() {
  return (
    <div className="bg-white relative rounded-[3px] shrink-0 w-full" data-name="Upload file selcted">
      <div aria-hidden="true" className="absolute border border-[#ecf0f3] border-solid inset-0 pointer-events-none rounded-[3px]" />
      <div className="flex flex-row items-center size-full">
...
function Upload3() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-start p-[8px] relative rounded-[3px] shrink-0 w-[477px]" data-name="Upload">
      <div aria-hidden="true" className="absolute border border-[#aeb2bc] border-dashed inset-0 pointer-events-none rounded-[3px]" />
      <SelectDetails1 />
      <UploadFileSelcted />
    </div>
  );
...
export default function UpdateExistingCompanies() {
  return (
    <div className="bg-white relative size-full" data-name="Update existing companies">
