import svgPaths from "./svg-urfqg7vyw2";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="data_object">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="data_object">
          <g id="Vector">
            <path d={svgPaths.p3d2c5d80} fill="#84899F" />
            <path d={svgPaths.p1bf89300} fill="#84899F" />
          </g>
        </g>
      </svg>
    </div>
...
function TableChart() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="table_chart">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="table_chart">
          <path d={svgPaths.p22f02280} fill="var(--fill-0, #84899F)" id="Vector" />
        </g>
      </svg>
    </div>
  );
