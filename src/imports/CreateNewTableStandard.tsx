import svgPaths from "./svg-9dgm1zxu4c";
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[96.548px] z-[2]" data-name="Moody\'s Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 97 16">
        <g clipPath="url(#clip0_5_10137)" id="Moody\'s Logo">
          <path d={svgPaths.p72f1a80} fill="var(--fill-0, white)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_5_10137">
...
function ExpandLess() {
  return (
    <div className="relative shrink-0 size-[20px] z-[1]" data-name="expand_less">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="expand_less">
          <path d={svgPaths.p185fccc0} fill="var(--fill-0, #84899F)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function TitleBar() {
  return (
    <div className="bg-[#f4f5f6] relative rounded-tl-[3px] rounded-tr-[3px] shrink-0 w-full" data-name="Title bar">
      <div className="size-full">
...
function Label14() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Label">
      <p className="font-['GT_America:Medium',_sans-serif] leading-[18px] not-italic relative shrink-0 text-[#3e4260] text-[13px] text-nowrap whitespace-pre">Relationship type</p>
      <Requird4 />
    </div>
  );
}
...
function TextIcon7() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Text & Icon">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] items-center overflow-clip relative rounded-[inherit] w-full">
        <p className="font-['GT_America:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#3e4260] text-[14px] text-nowrap whitespace-pre">Select relationship type</p>
      </div>
    </div>
  );
}
...
function FooterBar() {
  return (
    <div className="bg-[#f4f5f6] relative rounded-bl-[3px] rounded-br-[3px] shrink-0 w-full" data-name="Footer bar">
...
export default function CreateNewTableStandard() {
  return (
    <div className="bg-white relative size-full" data-name="Create new table - standard">
